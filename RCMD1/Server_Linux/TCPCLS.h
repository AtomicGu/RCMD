...
namespace TCPCLS
{
	namespace ERR
	{
		...
		// WSA错误类
		//
		class WSAError : public WinError
		{
		public:
			WSAError(int code);
		};
		...
		// Windows文件API错误类
		//
		class FileError : public WinError
		{
		public:
			FileError(int code);
		};
	...
	//
	class MemPack : public TCPPackage
	{
	public:
	...
	//
	class BlockPack :public TCPPackage
	{
	public:
		BlockPack();
	...
	// 文件包（将文件包装为包）
	//
	class FilePack :public TCPPackage
	{
	public:
	...
	// 接收包
	//
	class RecvPack :public TCPPackage
	{
	public:
